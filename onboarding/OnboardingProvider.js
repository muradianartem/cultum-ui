...
/**
 * Where this launch starts, from what is on disk and how the session began.
 *
 ...
 */
export function resolveInitial({ stored, signedInVia, override = null }) {
...
export function OnboardingProvider({ children, signedInVia = null, initial, override }) {
