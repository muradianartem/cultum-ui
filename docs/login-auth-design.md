...
- **Open question (non-blocking):** the **background image** — `assets/plant/hero.png` is a placeholder. Is there a real login artwork asset (or Figma frame) to use, and final copy for the title/tagline? Layout is built to accept a swap.
